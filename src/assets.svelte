<a-assets>
  ...
  <img id="logo-text" alt="" src="portfolio/indq book3.png" />
  ...
  />
      ...
      <!-- svelte-ignore a11y-media-has-caption -->
      <video id="colpo-gif" type="video/mp4"  autoplay loop="true" src="portfolio/colpo.mp4" />

    <!-- svelte-ignore a11y-media-has-caption -->
    <video id="jananya-gif" type="video/mp4"  autoplay loop="true" src="portfolio/jananya.mp4" />
  <!-- svelte-ignore a11y-media-has-caption -->
  <video id="bowel-gif" type="video/mp4"  autoplay loop="true" src="portfolio/bowel retractor.mp4" />  
 ...
 <!--back wall-->
  ...
  <img id="liquid-gif" alt="" src="portfolio/liquid.gif" />
   <!-- svelte-ignore a11y-media-has-caption -->
  <video id="tyro-gif" type="video/mp4"  autoplay loop="true" src="portfolio/tyro.mp4" />
